...
// Kiểm tra xem người dùng có nhập ID của bài học hay không
    ...
    <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            ...
            <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                    <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="/admin/index.php">
                    ...
                    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Danh mục</h1>
                                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                    ...
                                    <li class="breadcrumb-item text-muted">Bài học</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        <div class="card-header align-items-center border-0 mt-4">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="fw-bold text-dark">Chỉnh sửa bài học</span>
                                            </h3>
                                        </div>
                                        <form id="add" class="card-body pt-4 row">
                                            <div class="col-md-12 mb-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name" value="<?php echo $course["name"]; ?>" placeholder="Tên bài học" required>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mb-5">
                                                <div class="form-group">
                                                    <label>Hình ảnh</label>
                                                    <input type="url" class="form-control" name="image" value="<?php echo $course["image"]; ?>" placeholder="Đường dẫn hình ảnh" required>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mb-5">
                                                <div class="form-group">
                                                    <label>Mô tả</label>
                                                    <input type="text" class="form-control" name="description" value="<?php echo $course["description"]; ?>" placeholder="Đường dẫn hình ảnh" required>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mb-8">
                                                <div class="form-group">
                                                    <label>Youtube ID:</label>
                                                    <input type="text" class="form-control" name="link" value="<?php echo $course["link"]; ?>" placeholder="ID video của youtube" required>
                                                </div>
                                            </div>
        ...
        <script>
            $("#add").on("submit", function(e) {
                e.preventDefault();
                $.ajax({
                    url: "../../handler/admin/edit_course.php?id=<?php echo $_GET["id"]; ?>",
                    type: "POST",
                    data: $(this).serialize(),
                    dataType: "JSON",
                    success: (data) => {
