...
if ($get->num_rows > 0) {
    ...
    // Nếu danh mục không tồn tại hoặc đã bị xóa
    header('Location: index.php');
}
    ...
    <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        <div class="card-header align-items-center border-0 mt-4">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="fw-bold text-dark">Chỉnh sửa danh mục</span>
                                            </h3>
                                        </div>
                                        <form id="edit" class="card-body pt-4 row">
                                            <div class="col-md-12 mb-5">
                                                <div class="form-group">
                                                    <label>Tên danh mục</label>
                                                    <input type="text" class="form-control" name="title" value="<?php echo $category["title"]; ?>" placeholder="Tên danh mục" required>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mb-8">
                                                <div class="form-group">
                                                    <label>Hình ảnh</label>
                                                    <input type="url" class="form-control" name="image" value="<?php echo $category["image"]; ?>" placeholder="Đường dẫn hình ảnh" required>
                                                </div>
                                            </div>
        ...
        <script>
            $("#edit").on("submit", function(e) {
                e.preventDefault();
                $.ajax({
                    url: "../../handler/admin/edit_category.php?id=<?php echo $_GET["id"]; ?>",
                    type: "POST",
                    data: $(this).serialize(),
                    dataType: "JSON",
                    success: (data) => {
