...
// Kiểm tra xem người dùng có nhập ID của danh mục không
...
if ($get->num_rows > 0) {
    ...
    // Chuyển về trang index để tiếp tục chỉnh sửa
    ...
    <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        <div class="card-header align-items-center border-0 mt-4">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="fw-bold text-dark">Thêm bài học mới</span>
                                            </h3>
                                        </div>
                                        <form id="add" class="card-body pt-4 row">
                                            <div class="col-md-12 mb-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name" placeholder="Tên bài học" required>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mb-5">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12 mb-5">
                                                <div class="form-group">
                                                    <label>Mô tả</label>
                                                    <input type="text" class="form-control" name="description" placeholder="Đường dẫn hình ảnh" required>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mb-8">
                                                <div class="form-group">
                                                    <label>Youtube ID:</label>
                                                    <input type="text" class="form-control" name="link" placeholder="ID video của youtube" required>
                                                </div>
                                            </div>
        ...
        <script>
            $("#add").on("submit", function(e) {
                e.preventDefault();
                $.ajax({
                    url: "../../handler/admin/add_course.php?id=<?php echo $_GET["id"]; ?>",
                    type: "POST",
                    data: $(this).serialize(),
                    dataType: "JSON",
                    success: (data) => {
