...
// Kiểm tra xem url có chứa id của category hay không
if (!isset($_GET["category"])) {
    // Chuyển về trang chủ
    header("location: /");
} else {
    // Lấy dữ liệu các bài học trong bảng course thông qua id của category
    $get = $conn->query("SELECT * FROM course WHERE category_id = '{$_GET["category"]}'");
    if ($get->num_rows > 0) {
        $category = $conn->query("SELECT * FROM category WHERE id = '{$_GET["category"]}'")->fetch_array();
        // Nếu như người dùng đã chọn bài học
            ...
            <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
                ...
                <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                    <a href="/" class="d-lg-none">
                        <?php echo $_SESSION["username"] ?? "Chưa đăng nhập"; ?>
                    </a>
                </div>
            ...
            <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                    ...
                    <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                        <div class="menu-item pt-5">
                            <div class="menu-content">
                                <span class="menu-heading fw-bold text-uppercase fs-7">Danh sách bài học</span>
                            </div>
                        </div>
                ...
                <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
                    <?php if (!isset($_SESSION["username"])) {?>
                        <a href="login.php" class="btn btn-flex flex-center btn-primary overflow-hidden text-nowrap px-0 h-40px w-100">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                    ...
                                    <?php } else { ?>
                                        <li class="breadcrumb-item text-muted"><?php echo $category["title"]; ?></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <iframe class="w-100 h-550px embed-responsive-item"
                                                            src="https://www.youtube.com/embed/<?php echo $course["link"]; ?>"
